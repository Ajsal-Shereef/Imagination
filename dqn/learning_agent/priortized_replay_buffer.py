...
from dqn.learning_agent.segment_tree import MinSegmentTree, SumSegmentTree
...
class PrioritizedReplayBuffer(ReplayBuffer):
    ...
    def sample(self, beta=0.4, is_to_tensor=True):
        ...
        states, actions, rewards, next_states, dones, info = super().sample(indices, is_to_tensor=is_to_tensor)

        return states, actions, rewards, next_states, dones, info, weights, indices, eps_d
