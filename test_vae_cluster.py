...
while total_step < 20000:
    ...
    while True:
        ...
        if cluster_prob[0][0] > 0.85:
            print("First gaussian is greater than 90% " + env.extract_objects_from_observation()[1])
        elif cluster_prob[0][1] > 0.85:
            print("Second gaussian is greater than 90% " + env.extract_objects_from_observation()[1])
